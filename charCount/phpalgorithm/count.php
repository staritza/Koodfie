...
/* todo: 
 * 1. write a function that counts the number of characters in the text
 * counts the number of times each character occurs, and then outputs these numbers nicely in a table
 * 2. represent open E and open O in their unicode forms rather than the inconprehensible ways they're seen in UTF-8 
**/
